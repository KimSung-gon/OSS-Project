public class Searching extends CommonStaticMethod {
    ...
    public static void searchDataOfStudent(int studentIdx) {
        if (studentIdx == -1)
    ...
    public static void searchStudentDataOfSubject(String subject) {
    ...
    public static void searchStudentDataOfMajor(String major) {
    ...
    public static void searchDataOfYear(int year) {
